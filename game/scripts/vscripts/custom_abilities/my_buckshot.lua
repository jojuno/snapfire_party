...
function my_buckshot:OnSpellStart()
    ...
    print("[my_buckshot:OnSpellStart] called")
...
function my_buckshot:OnProjectileHit(hTarget, vLocation)
    if hTarget == nil then
        --self.projectileExpiredTime = GameRules:GetGameTime()
        print("[my_buckshot:OnProjectileHit] scatterblast expired")
